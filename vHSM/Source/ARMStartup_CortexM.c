/**
 * @file        ARMStartup_CortexM.c
 * @brief       Public header: BrsHw.h, vBrs_Lcfg.h
 * @details     Startup code and vector table implementation for ARM Cortex-M in the Basic Runtime System.
 */
/**********************************************************************************************************************
 *  COPYRIGHT
 *  -------------------------------------------------------------------------------------------------------------------
...
/**
 * @def        ARMSTARTUP_CORTEXM_SOURCE
 * @value      -
 * @resolution -
 * @brief      Marks this file as the source definition for ARM Cortex-M startup code.
 */
...
/**
* @def          BRSHW_CPACR
* @value        (*((volatile uint32 *)(0xE000ED88U)))
* @resolution   -
* @brief        Coprocessor Access Control Register
*/
#define BRSHW_CPACR (*((volatile uint32 *)(0xE000ED88U)))
 
/**
* @def          BRSHW_FPCCR
* @value        (*((volatile uint32 *)(0xE000EF34U)))
* @resolution   -
* @brief        Floating-Point Context Control Register
*/
#define BRSHW_FPCCR (*((volatile uint32 *)(0xE000EF34U)))
 ...
 * |:--------:|:--------:|:---------------:|
 * |-         |-         |-                |
 * @par specified address output by arguments
 * |Type      |Name      |Description      |
 * |:--------:|:--------:|:---------------:|
 * |-         |-         |-                |
 ...
 * |Type      |Name      |Description      |
 * |:--------:|:--------:|:---------------:|
 * |-         |BRSHW_CPACR         |Coprocessor Access Control Register                |
 * |-         |BRSHW_FPCCR         |Floating-Point Context Control Register                |
 * @par automatic variables
 * |Type      |Name      |Description      |
 * |:--------:|:--------:|:---------------:|
 * |-         |-         |-                |
 * @brief   Enable the FPU coprocessors, because some HwSpec functions and tests use floating point numbers.
 * @note    must be called from startup code as Os_Init expects the FPU registers to be setup by the customer.
 */
/* author                 */
/* date                   */
/************************************************************************************************/
void Brs_EnableFpu(void)
{
  BRSHW_CPACR = BRSHW_CPACR | (0xFU << 20u);
  BRSHW_FPCCR = (BRSHW_FPCCR & ~(0x1U << 30u)) | (0x1U << 31u); /* Set FPCCR.ASPEN, Reset FPCCR.LSPEN. */
}
#endif /*BRS_FPU_USED*/
