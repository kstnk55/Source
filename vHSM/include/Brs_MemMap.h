/**
 * @file Brs_MemMap.h
 * @brief Public header: vBrsCfg.h, BrsMain.h (This module provided by Vector should be left unchanged by FPT.)
 * @details Module for memory section mapping in Vector BRS. 
 */
/**********************************************************************************************************************
 *  COPYRIGHT
 *  -------------------------------------------------------------------------------------------------------------------
...
#  if defined (BRS_COMP_GHS)
  #pragma ghs section rodata = ".brsExcVectRam"
