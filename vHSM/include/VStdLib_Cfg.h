/**
 * @file VStdLib_Cfg.h
 * @brief Configuration header for Vector Standard Library (This module provided by Nippon Seiki should be left unchanged by FPT.)
 * @details Project-specific configuration for VStdLib. 
 */
/**********************************************************************************************************************
 *  COPYRIGHT
 *  -------------------------------------------------------------------------------------------------------------------
...
# define VSTDLIB_CFG_MINOR_VERSION     (3u)
