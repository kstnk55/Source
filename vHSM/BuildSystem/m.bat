...
set MAKESUPPORT_DIR=..\Core\MakeSupport
...
set RETURN_CODE=0
rem signing and create dual bank binaries
call %~dp0..\Tool\CM0_SecureBoot\Secure_Complete_SREC_to_CYP_3K_HexView.bat
call %~dp0..\Tool\CM0_SecureBoot\Merge_SFlash_and_veHSM.bat
call %~dp0..\Tool\CM0_SecureBoot\Create_DualBank_Binary.bat
goto End
