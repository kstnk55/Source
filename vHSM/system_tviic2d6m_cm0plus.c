...
#include "cy_project.h"
    ...
    // PLL_OUT = 20,000,000(Feco) / 5 * 160 / 2 = 320,000,000Hz
    // Restriction: 400,000,000 <= Fvco <= 800,000,000
    // This time, Fvco = 20,000,000 * 160 / 5 = 640,000,000.
    #define CY_SYSTEM_PLL0_CONFIG_REFDIV      (5UL)
    #define CY_SYSTEM_PLL0_CONFIG_FEEDBACKDIV (160UL)
    #define CY_SYSTEM_PLL0_CONFIG_OUTDIV      (2UL)
  #elif (CY_SYS_PLL400M_0_FREQ == CY_SYS_PLL400M_0_250MHz)
    // PLL_OUT = 20,000,000(Feco) / 4 * 125 / 2 = 312,500,000Hz
    // Restriction: 400,000,000 <= Fvco <= 800,000,000
    // This time, Fvco = 20,000,000 * 125 / 4 = 625,000,000.
    #define CY_SYSTEM_PLL0_CONFIG_REFDIV      (4UL)
    #define CY_SYSTEM_PLL0_CONFIG_FEEDBACKDIV (125UL)
    #define CY_SYSTEM_PLL0_CONFIG_OUTDIV      (2UL)
  #else
    // PLL_OUT = 20,000,000(Feco) / 1 * 30 / 3 = 200,000,000Hz
    // Restriction: 400,000,000 <= Fvco <= 800,000,000
    // This time, Fvco = 20,000,000 * 30 / 1 = 600,000,000.
    ...
    // PLL_OUT = 20,000,000(Feco) / 4 * 133.72799985 / 2 = 334,319,999.6Hz
    // Restriction: 400,000,000 <= Fvco <= 800,000,000
    // This time, Fvco = 20,000,000 * 133.72799985 / 4 = 668,639,999.2.
    #define CY_SYSTEM_PLL1_CONFIG_REFDIV      (4UL)
    #define CY_SYSTEM_PLL1_CONFIG_FB_INT      (133UL)
    #define CY_SYSTEM_PLL1_CONFIG_FB_FRAC     (12213813UL)
    #define CY_SYSTEM_PLL1_CONFIG_OUTDIV      (2UL)
 
    // PLL_OUT = 20,000,000(Feco) / 4 * 133 / 2 = 332,500,000Hz
    // Restriction: 400,000,000 <= Fvco <= 800,000,000
    // This time, Fvco = 20,000,000 * 133 / 4 = 665,000,000.
    ...
    // PLL_OUT = 20,000,000(Feco) / 4 * 100 / 2 = 250,000,000Hz
    // Restriction: 400,000,000 <= Fvco <= 800,000,000
    // This time, Fvco = 20,000,000 * 100 / 4 = 500,000,000.
    ...
    // PLL_OUT = 20,000,000(Feco) / 1 * 21 / 7 = 60,000,000Hz
    // Restriction: 400,000,000 <= Fvco <= 800,000,000
    // This time, Fvco = 20,000,000 * 21 / 1 = 420,000,000.
    #define CY_SYSTEM_PLL4_CONFIG_REFDIV      (1UL)
    #define CY_SYSTEM_PLL4_CONFIG_FEEDBACKDIV (21UL)
    #define CY_SYSTEM_PLL4_CONFIG_OUTDIV      (7UL)
 
    // PLL_OUT = 20,000,000(Feco) / 4 * 80 / 2 = 200,000,000Hz
    // Restriction: 170,000,000 <= Fvco <= 400,000,000
    // This time, Fvco = 20,000,000 * 80 / 4 = 400,000,000.
    #define CY_SYSTEM_PLL5_CONFIG_REFDIV      (4UL)
    #define CY_SYSTEM_PLL5_CONFIG_FEEDBACKDIV (80UL)
    #define CY_SYSTEM_PLL5_CONFIG_OUTDIV      (2UL)
 
    // PLL_OUT = 20,000,000(Feco) / 4 * 64 / 4 = 80,000,000Hz
    // Restriction: 170,000,000 <= Fvco <= 400,000,000
    // This time, Fvco = 20,000,000 * 64 / 4 = 320,000,000.
    #define CY_SYSTEM_PLL6_CONFIG_REFDIV      (4UL)
    #define CY_SYSTEM_PLL6_CONFIG_FEEDBACKDIV (64UL)
    #define CY_SYSTEM_PLL6_CONFIG_OUTDIV      (4UL)
 
    // PLL_OUT = 20,000,000(Feco) / 4 * 80 / 2 = 200,000,000Hz
    // Restriction: 170,000,000 <= Fvco <= 400,000,000
    // This time, Fvco = 20,000,000 * 80 / 4 = 400,000,000.
    #define CY_SYSTEM_PLL7_CONFIG_REFDIV      (4UL)
    #define CY_SYSTEM_PLL7_CONFIG_FEEDBACKDIV (80UL)
...
void SystemInit (void)
{
    ...
    SRSS->unCLK_ECO_CONFIG2.stcField.u3WDTRIM = 5u;
    SRSS->unCLK_ECO_CONFIG2.stcField.u4ATRIM  = 10u;
    SRSS->unCLK_ECO_CONFIG2.stcField.u2FTRIM  = 3u;
    SRSS->unCLK_ECO_CONFIG2.stcField.u2RTRIM  = 2u;
    SRSS->unCLK_ECO_CONFIG2.stcField.u3GTRIM  = 4u;
 
    SRSS->unCLK_ECO_CONFIG.stcField.u1AGC_EN          = 1ul;
...
#if 0 /* FPT modified: stability waiting process move to M7. */
    ...
    /* Settings for FLL */
    SRSS->unCLK_PATH_SELECT[0/*FLL*/].stcField.u3PATH_MUX = CY_SYSCLK_CLKPATH_IN_IMO;
 
    /* update CLK_FLL_CONFIG register */
    SRSS->unCLK_FLL_CONFIG.stcField.u18FLL_MULT      = 250ul;
    SRSS->unCLK_FLL_CONFIG.stcField.u1FLL_OUTPUT_DIV = 1ul;
 
    /* update CLK_FLL_CONFIG2 register */
    SRSS->unCLK_FLL_CONFIG2.stcField.u13FLL_REF_DIV  = 10ul;
    SRSS->unCLK_FLL_CONFIG2.stcField.u8LOCK_TOL      = 23ul;
    SRSS->unCLK_FLL_CONFIG2.stcField.u8UPDATE_TOL    = 3ul;
 
    /* update CLK_FLL_CONFIG3 register */
    SRSS->unCLK_FLL_CONFIG3.stcField.u4FLL_LF_IGAIN    = 10ul;
    SRSS->unCLK_FLL_CONFIG3.stcField.u4FLL_LF_PGAIN    = 6ul;
    SRSS->unCLK_FLL_CONFIG3.stcField.u13SETTLING_COUNT = 8ul;
    SRSS->unCLK_FLL_CONFIG3.stcField.u2BYPASS_SEL      = 0ul;
 
    /* update CLK_FLL_CONFIG4 register; preserve other bits */
    SRSS->unCLK_FLL_CONFIG4.stcField.u8CCO_LIMIT         = 255ul;
    SRSS->unCLK_FLL_CONFIG4.stcField.u3CCO_RANGE         = 4ul;
    SRSS->unCLK_FLL_CONFIG4.stcField.u9CCO_FREQ          = 288ul;
    SRSS->unCLK_FLL_CONFIG4.stcField.u1CCO_HW_UPDATE_DIS = 0ul;
    ...
    /* Lock occurred; we need to clear the unlock occurred bit. Do so by writing a 1 to it. */
    ...
    SRSS->CLK_PLL400M[0].unCONFIG2.stcField.u3FRAC_DITHER_EN = 0ul;
    SRSS->CLK_PLL400M[0].unCONFIG2.stcField.u24FRAC_DIV = 0ul;
    ...
    SRSS->CLK_PLL400M[0].unCONFIG3.stcField.u1SSCG_DITHER_EN = 0ul;   /* Disabled */
    ...
    SRSS->CLK_PLL400M[1].unCONFIG2.stcField.u3FRAC_DITHER_EN = 0ul;
    SRSS->CLK_PLL400M[1].unCONFIG2.stcField.u24FRAC_DIV = 0ul;
    SRSS->CLK_PLL400M[1].unCONFIG2.stcField.u1FRAC_EN      = 0ul;    /* Enabled */
 
    SRSS->CLK_PLL400M[1].unCONFIG3.stcField.u10SSCG_DEPTH  = 0x0A4ul;
    SRSS->CLK_PLL400M[1].unCONFIG3.stcField.u3SSCG_RATE    = 3ul;    
    SRSS->CLK_PLL400M[1].unCONFIG3.stcField.u1SSCG_DITHER_EN = 0ul;  
    SRSS->CLK_PLL400M[1].unCONFIG3.stcField.u1SSCG_MODE    = 0ul;    
    SRSS->CLK_PLL400M[1].unCONFIG3.stcField.u1SSCG_EN      = 1ul;    /* Enabled */
    ...
    SRSS->CLK_PLL400M[2].unCONFIG2.stcField.u3FRAC_DITHER_EN = 0ul;
    SRSS->CLK_PLL400M[2].unCONFIG2.stcField.u24FRAC_DIV = 0ul;
    SRSS->CLK_PLL400M[2].unCONFIG2.stcField.u1FRAC_EN      = 0ul;     /* Disabled */
 
    SRSS->CLK_PLL400M[2].unCONFIG3.stcField.u10SSCG_DEPTH  = 0x0A4ul; /* -0.5% (down-spread) */
    SRSS->CLK_PLL400M[2].unCONFIG3.stcField.u3SSCG_RATE    = 3ul;     /* Modulation rate = fPFD/4096 */
    SRSS->CLK_PLL400M[2].unCONFIG3.stcField.u1SSCG_DITHER_EN = 0ul;   /* Disabled */
    ...
    SRSS->CLK_PLL400M[3].unCONFIG2.stcField.u3FRAC_DITHER_EN = 0ul;
    SRSS->CLK_PLL400M[3].unCONFIG2.stcField.u24FRAC_DIV = 0ul;
    SRSS->CLK_PLL400M[3].unCONFIG2.stcField.u1FRAC_EN      = 0ul;     /* Disabled */
 
    SRSS->CLK_PLL400M[3].unCONFIG3.stcField.u10SSCG_DEPTH  = 0x0A4ul; /* -0.5% (down-spread) */
    SRSS->CLK_PLL400M[3].unCONFIG3.stcField.u3SSCG_RATE    = 3ul;     /* Modulation rate = fPFD/4096 */
    SRSS->CLK_PLL400M[3].unCONFIG3.stcField.u1SSCG_DITHER_EN = 0ul;   /* Enabled */
    ...
    SRSS->CLK_PLL400M[4].unCONFIG2.stcField.u3FRAC_DITHER_EN = 0ul;
    SRSS->CLK_PLL400M[4].unCONFIG2.stcField.u24FRAC_DIV = 0ul;
    SRSS->CLK_PLL400M[4].unCONFIG2.stcField.u1FRAC_EN      = 1ul;     /* Enabled */
 
    SRSS->CLK_PLL400M[4].unCONFIG3.stcField.u10SSCG_DEPTH  = 0x0A4ul; /* -0.5% (down-spread) */
    SRSS->CLK_PLL400M[4].unCONFIG3.stcField.u3SSCG_RATE    = 3ul;     /* Modulation rate = fPFD/4096 */
    ...
    SRSS->CLK_PLL400M[4].unCONFIG3.stcField.u1SSCG_EN      = 0ul;
    ...
    struct {cy_en_hf_clk_dividers_t targetDiv; cy_en_hf_clk_sources_t source;} clkHfSetting[SRSS_NUM_HFROOT] =
    {
        ...
        { .targetDiv = CY_SYSCLK_HFCLK_DIVIDE_BY_2, .source = CY_SYSCLK_HFCLK_IN_CLKPATH2 /* PLL1: PLL400#1 */ }, // setting for clk_hf5  // Dividing by 8 to make clock equal to 12.25MHz
        { .targetDiv = CY_SYSCLK_HFCLK_NO_DIVIDE,   .source = CY_SYSCLK_HFCLK_IN_CLKPATH6 /* PLL1: PLL400#1 */ }, // setting for clk_hf6
        { .targetDiv = CY_SYSCLK_HFCLK_NO_DIVIDE,   .source = CY_SYSCLK_HFCLK_IN_CLKPATH9 /* PLL1: PLL400#1 */ }, // setting for clk_hf7
        { .targetDiv = CY_SYSCLK_HFCLK_DIVIDE_BY_2,   .source = CY_SYSCLK_HFCLK_IN_CLKPATH2 /* PLL2: PLL400#2 */ }, // setting for clk_hf8
        { .targetDiv = CY_SYSCLK_HFCLK_DIVIDE_BY_2,   .source = CY_SYSCLK_HFCLK_IN_CLKPATH3 /* PLL2: PLL400#2 */ }, // setting for clk_hf9
        ...
        { .targetDiv = CY_SYSCLK_HFCLK_NO_DIVIDE,   .source = CY_SYSCLK_HFCLK_IN_CLKPATH5 /* PLL7: PLL200#2 */ }, // setting for clk_hf12
    ...
    for(int8_t i_clkHfNo = 0ul; i_clkHfNo < SRSS_NUM_HFROOT; i_clkHfNo++)
    {
        if(i_clkHfNo == TIMING_MONZA_PMIC_ENABLE)
        {
            ...
            /***   Enabling MONZA PMIC     ***/
            //Cy_Power_SwitchToPmic(16, 1, 0, 1000u); /*FixBuildCM0*/
    ...
    /***     Enabling ILO0 and ILO1     ***/
    Cy_WDT_Unlock();
    SRSS->unCLK_ILO0_CONFIG.stcField.u1ILO0_BACKUP     = 0ul;
    SRSS->unCLK_ILO0_CONFIG.stcField.u1ILO0_MON_ENABLE = 0ul;
    SRSS->unCLK_ILO0_CONFIG.stcField.u1ENABLE          = 1ul;
 
    SRSS->unCLK_ILO1_CONFIG.stcField.u1ILO1_MON_ENABLE = 0ul;
    SRSS->unCLK_ILO1_CONFIG.stcField.u1ENABLE          = 1ul;
    Cy_WDT_Lock();
    ...
    /* Config Peripheral clock devider for PCLK_TCPWM0_CLOCKS0 */
    uint8_t peri_no_clks0 = (uint8_t)(PCLK_TCPWM0_CLOCKS0 & 0x00FFu);
    PERI_PCLK->GR[0].unCLOCK_CTL[peri_no_clks0].stcField.u2TYPE_SEL = CY_SYSCLK_DIV_24_5_BIT;
    PERI_PCLK->GR[0].unCLOCK_CTL[peri_no_clks0].stcField.u8DIV_SEL  = PERI_PERI_PCLK_PCLK_GROUP_NR0_GR_DIV_24_5_VECT;
 
    PERI_PCLK->GR[0].unDIV_24_5_CTL[PERI_PERI_PCLK_PCLK_GROUP_NR0_GR_DIV_24_5_VECT].stcField.u24INT24_DIV = 0;
    PERI_PCLK->GR[0].unDIV_24_5_CTL[PERI_PERI_PCLK_PCLK_GROUP_NR0_GR_DIV_24_5_VECT].stcField.u5FRAC5_DIV = 8;
 
    PERI_PCLK->GR[0].unDIV_CMD.stcField.u1ENABLE      = 1ul;
    PERI_PCLK->GR[0].unDIV_CMD.stcField.u2PA_TYPE_SEL = 3ul;
    PERI_PCLK->GR[0].unDIV_CMD.stcField.u8PA_DIV_SEL  = 0xFFul;
    PERI_PCLK->GR[0].unDIV_CMD.stcField.u2TYPE_SEL    = CY_SYSCLK_DIV_24_5_BIT;
    PERI_PCLK->GR[0].unDIV_CMD.stcField.u8DIV_SEL     = PERI_PERI_PCLK_PCLK_GROUP_NR0_GR_DIV_24_5_VECT;
