...
* \{
*/
#define CY_SI_SECURE_SFLASH_BEGIN		(0x17000800UL)	/**< Secure Image begin SFlash address */
...
* Normal Access restriction for CM0+ access poert.
* \{
*/
...
/** \defgroup group_CM4_acc_restriction_macros Normal Access restriction
* Normal Access restriction for CM4 access poert.
* \{
*/
...
/** \} group_CM4_acc_restriction_macros */

/** \defgroup group_SYS_acc_restriction_macros Normal Access restriction
* Normal Access restriction for System access poert.
* \{
*/
...
* \{
*/
#define CY_SI_SECURE_FLASH_BEGIN_CM4	(0x10020000UL)	/**< Secure Image begin Flash address. Configure depends on System. */
#define CY_M4_SI_SIZE					(0x0000FE00UL)	/**< Authentication Size Configure depends on System. */
#define CY_SI_SIGNATURE_ADDR			(0x1002FE00UL)	/**< Signature address Configure depends on System. */
...
#define CY_SI_PUBLIC_KEY					(0x17006400UL)	/**< 2K PUBLIC KEY address in SFlash */
#define CY_SI_PUBLIC_KEY_3K					(0x17006900UL)	/**< 3K PUBLIC KEY address in SFlash */
...
#define CY_SI_CM4_AP_POS				(2UL)	/**< Bit position of CM4 ACCESS PORT*/
