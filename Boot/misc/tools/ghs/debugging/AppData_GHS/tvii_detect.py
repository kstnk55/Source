...
# 2023-03-06 0.04 CHEY  Extend CodeFlash check for flash macro #1 and make it more robust, change
#                       some strings
# ***********************************************************************************************/#
...
CODE_FLASH0_BASE_ADDRESS = 0x10000000
...
# Returns True if symbol address of "main" is within CODE_FLASH #0 or #1 region, otherwise False
def IsApplicationLinkedForFlash():
    address_to_check = debugger.GetSymbolAddress("_start")
    if address_to_check == 0:
        address_to_check = debugger.GetSymbolAddress("main")
    if (address_to_check >= CODE_FLASH0_BASE_ADDRESS) and (address_to_check < (CODE_FLASH0_BASE_ADDRESS + CODE_FLASH_SIZE_BYTES)):
        return True
    elif (address_to_check >= CODE_FLASH1_BASE_ADDRESS) and (address_to_check < (CODE_FLASH1_BASE_ADDRESS + CODE_FLASH_SIZE_BYTES)):
        return True        
    else:
        return False
...
if IsApplicationLinkedForFlash() is False:
    ExecDebugCmd("debugbutton traveo_ii_ram    c=\"" + command_ram_download  + "\" i=\"letter_r16\" t=\"Traveo II: Connect and load RAM\"")
else:
    ExecDebugCmd("debugbutton traveo_ii_flash  c=\"" + command_flash_program + "\" i=\"letter_f16\" t=\"Traveo II: Connect and program flash\"")
    
# Following buttons are available for any build configuration
ExecDebugCmd("debugbutton traveo_ii_verify c=\"" + command_verify + "\" i=\"letter_v16\" t=\"Traveo II: Connect and verify only\"")
ExecDebugCmd("debugbutton traveo_ii_erase  c=\"" + command_erase  + "\" i=\"letter_e16\" t=\"Traveo II: Connect and erase flash\"")
