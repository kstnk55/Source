...
#elif defined (CYT4DNJBTS)
    #include "cyt4dnjbts.h"
#elif defined (CYT4DNJBUS)
    #include "cyt4dnjbus.h"
#elif defined (CYT4DNJBVS)
    #include "cyt4dnjbvs.h"
#elif defined (CYT4DNJBWS)
    #include "cyt4dnjbws.h"
#elif defined (CYT4DNJBXS)
    #include "cyt4dnjbxs.h"
#elif defined (CYT4DNJBYS)
    #include "cyt4dnjbys.h"
